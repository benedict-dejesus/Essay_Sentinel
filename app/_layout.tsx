...
export default function RootLayout() {
  ...
  const content = <GestureHandlerRootView style={{ flex: 1 }}><Stack screenOptions={{ headerShown: false }}><Stack.Screen name="(tabs)" /><Stack.Screen name="review" /><Stack.Screen name="findings/[id]" /></Stack><StatusBar style="dark" /></GestureHandlerRootView>;
